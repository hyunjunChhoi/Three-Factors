...
if args.load != '':
    for i in range(1000 - 1, -1, -1):
        ...
        model_name = os.path.join(os.path.join(args.load, subdir), args.method_name + '_epoch_' + str(i)+'_dstemp_'+str(args.dstemp)+ '_quantile_' + str(args.quantile)+'_loss_mode_'+str(args.loss_mode)+'_times_'+str(args.n)+ '_beta_' + str(args.beta1)+ str(args.beta2)+'_OE_trial_'+str(args.trial)  + '.pt')
