...
with open(os.path.join(args.save, args.dataset + calib_indicator + '_' + args.model + '_s' + str(args.seed) +
                                  '_' + save_info + '_gamma_' + str(args.gamma1)+ str(args.gamma2)+'_dstemp_'+str(args.dstemp)+ '_quantile_' + str(args.quantile) +'_loss_mode_'+str(args.loss_mode)+'_times_'+str(args.n)+ '_beta_' + str(args.beta1)+ str(args.beta2) + '_trial_' + str(
...
for epoch in range(0, args.epochs):
    ...
    torch.save(net.state_dict(),
               os.path.join(args.save, args.dataset + calib_indicator + '_' + args.model + '_s' + str(args.seed) +
                            '_' + save_info + '_epoch_' + str(epoch) + '_gamma_' + str(args.gamma1)+ str(args.gamma2)+'_dstemp_'+str(args.dstemp)+ '_quantile_' + str(args.quantile)+'_loss_mode_'+str(args.loss_mode)+'_times_'+str(args.n)+ '_beta_' + str(args.beta1)+ str(args.beta2) + '_trial_' + str(
                   args.trial) + '.pt'))

    # Let us not waste space and delete the previous model
    prev_path = os.path.join(args.save, args.dataset + calib_indicator + '_' + args.model + '_s' + str(args.seed) +
                             '_' + save_info + '_epoch_' + str(epoch - 1) + '_gamma_' + str(args.gamma1)+ str(args.gamma2)+'_dstemp_'+str(args.dstemp)+ '_quantile_' + str(args.quantile) +'_loss_mode_'+str(args.loss_mode)+'_times_'+str(args.n)+ '_beta_' + str(args.beta1)+ str(args.beta2)+ '_trial_' + str(args.trial) + '.pt')
