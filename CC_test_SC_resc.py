...
parser.add_argument('--load', '-l', type=str, default='./snapshots/O_base_con/', help='Checkpoint path to resume / test.')
...
if args.load != '':
    for i in range(1000 - 1, -1, -1):
        if 'pretrained' in args.method_name:
            ...
            subdir = 'oe_scratch'
        model_name = os.path.join(os.path.join(args.load, subdir), new_method_name + '_epoch_' + str(i)+'_CC_trial_'+str(args.trial)  + '.pt')
